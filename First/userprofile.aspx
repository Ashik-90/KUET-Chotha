<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="First.userprofile" %>
      ...
      <div class="row">
         <div class="col-md-5">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="form-group" style="margin:10px">
                             <label>Roll</label>
                             <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Roll Number" TextMode="Number" ReadOnly="True"> </asp:TextBox>
                         </div>
                         </div>
                    </div>
            ...
            <div class="form-group" >
                              <center>
                              <asp:Button class="btn btn-primary btn-lg" runat="server" ID="Button1" Text="Update"/>
                            </center>
                 </div>
